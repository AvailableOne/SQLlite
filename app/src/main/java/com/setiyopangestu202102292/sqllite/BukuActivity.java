    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(txtkode) || TextUtils.isEmpty(txtjudul) || TextUtils.isEmpty(txtpengarang)
                    ...
                    boolean checkkode = db.checkNim(txtkode);
                    if (!checkkode) {
                        boolean insert = db.insertDataBOOK(txtkode, txtjudul, txtpengarang, txtpenerbit, txtisbn);
                        if (insert) {
        ...
        hapus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isDeleted = db.hapusDataBOOK(kodeToDelete);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(newkode) || TextUtils.isEmpty(newjudul) || TextUtils.isEmpty(newpengarang)
                    ...
                    boolean isUpdated = db.editDataBOOK(newkode, newjudul, newpengarang, newpenerbit, newisbn);
