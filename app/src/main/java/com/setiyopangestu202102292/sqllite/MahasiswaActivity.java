    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(txtnim) || TextUtils.isEmpty(txtnama) || TextUtils.isEmpty(txtjk)
                    ...
                    if (!checkkode) {
                        boolean insert = db.insertDataMhs(txtnim, txtnama, txtjk, txtalamat, txtemail);
                        if (insert) {
        ...
        hapus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isDeleted = db.hapusDataMhs(nimToDelete);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(nimToUpdate) || TextUtils.isEmpty(newNama) || TextUtils.isEmpty(newJenisKelamin)
                    ...
                    boolean isUpdated = db.editDataMhs(nimToUpdate, newNama, newJenisKelamin, newAlamat, newEmail);
